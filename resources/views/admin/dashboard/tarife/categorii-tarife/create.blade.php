    ...
    <div class="py-12">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                <div class="p-4">
                    <form action="{{ route('categorii-tarife.store') }}" method="POST">
                        @csrf

                        <div>

                            {{-- <select name="parent_id" id="" class="w-full mb-6 border-none rounded-md">
                                <option value="">Select Parent Category</option>
                                    @foreach($categorii-tarife as $category)
