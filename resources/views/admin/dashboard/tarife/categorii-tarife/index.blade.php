                        ...
                        <tr>
                            ...
                            <td class="px-2 py-4 text-sm text-gray-500 whitespace-nowrap">
                                <div class="flex justify-start space-x-1">
                                    ...
                                    <a href="{{ route('categorii-tarife.edit', $categorie) }}" class="p-1 border-2 border-indigo-200 rounded-md">
                                    ...
                                    <form action="{{ route('categorii-tarife.delete', $categorie) }}" method="POST">
                                        @csrf
                                        @method('Delete')
