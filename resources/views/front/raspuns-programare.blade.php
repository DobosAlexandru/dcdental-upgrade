...
<section class="pb-12">
    <div class="container px-3 md:px-0 mx-auto">
        <div class="py-36">
            ...
            <p class="mt-8 max-w-xl mx-auto mt-2 text-center text-indigo-700 opacity-70 2xl:text-lg">Vom lua legatura cu
                dumneavoastră în cel mai scurt timp posibil. <br>Pentru urgențe vă rugăm sa contactați clinica DC dental
                cea mai aproape de dumneavoastră.</p>
        </div>
        <div class="-mx-3 lg:-mx-5 mt-12 md:flex">
            <div class="px-3 lg:px-5 w-full md:w-1/2" id="iasi">
                <div class="max-w-lg mx-auto xl:mr-0 shadow rounded-lg">
                    <img src="{{asset('images/dc-dental-cabinet-5.jpg')}}" alt="Clinica DC dental">
                    <div class="p-5 md:p-8 bg-white" id="#botosani">
                        ...
                        <div class="mt-5 md:-mx-3 flex flex-wrap">
                            ...
                            <div class="mt-5 px-1 md:px-3 w-1/2">
                                ...
                                <a href="tel:0754242241" class="mt-2 font-light text-base block hover:text-indigo-500"
                                    title="Contacteaza-ne la 0754 242 241">0754 242 241</a>
                            </div>
                            <div class="mt-5 px-1 md:px-3 w-1/2">
                                <p class="font-semibold">Email</p>
                                <a href="mailto:office@dcdental.ro"
                                    class="mt-2 font-light text-base block hover:text-indigo-500"
                                    title="Scrie-ne la office@dcdental.ro">office@dcdental.ro</a>
                            </div>
                        </div>
                    </div>
                    <a href="{{route('locatii.iasi')}}" title="{{ config('settings.site_name') }} Iasi"
            ...
            <div class="mt-12 md:mt-0 px-3 lg:px-5 w-full md:w-1/2" id="botosani">
                <div
                    class="mt-6 md:mt-0 max-w-lg mx-auto xl:ml-0 md:h-full flex flex-col justify-between shadow rounded-lg">
                    <img src="{{asset('images/dc-dental-botosani.jpeg')}}" alt="Clinica DC dental">
                    <div class="p-3 md:p-8 bg-white rounded-b-lg flex-1" id="#botosani">
                        ...
                        <div class="mt-5 md:-mx-3 flex flex-wrap">
                            ...
                            <div class="mt-5 px-1 md:px-3 w-1/2">
                                <p class="font-semibold">Telefon</p>
                                <a href="tel:0787695411" class="mt-2 font-light text-base block hover:text-indigo-500"
                                    title="Contacteaza-ne la 0787 695 411">0787 695 411</a>
                            </div>
                            <div class="mt-5 px-1 md:px-3 w-1/2">
                                <p class="font-semibold">Email</p>
                                <a href="mailto:office@dcdental.ro"
